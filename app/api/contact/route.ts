      ...
      try {
        await resend.emails.send({
          ...
          html: buildBrandedEmail({
            ...
            footerNote: "Mahjong Made Social. You’re receiving this because someone submitted a contact form through The Mahjong Open.",
          }),
        });
      ...
      try {
        await resend.emails.send({
          ...
          html: buildBrandedEmail({
            ...
            footerNote: "Mahjong Made Social. You’re receiving this because you contacted The Mahjong Open.",
          }),
        });
