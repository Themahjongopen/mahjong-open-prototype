      ...
      {viewAsPlayer ? (
        <div style={{ background: "#fff", border: "1px solid var(--hair-200)", borderRadius: "var(--radius-lg)", padding: 24, boxShadow: "var(--shadow-sm)" }}>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            ...
            <a href="/handbook/the-mahjong-open-handbook-2026-3.pdf" target="_blank" rel="noopener noreferrer" className="btn btn-ghost" style={{ justifyContent: "center" }}>Open rulebook</a>
          </div>
        </div>
      ) : (
