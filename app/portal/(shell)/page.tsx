      ...
      {canAddCity ? (
        <div style={{ background: "var(--pink-50)", border: "1px solid var(--pink-100)", borderRadius: "var(--radius-lg)", padding: "14px 16px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, marginBottom: 12 }}>
          <div>
            ...
            <p style={{ fontSize: 13, color: "var(--ink-700)", margin: 0 }}>Want to play in more than one city? Register for another city this league. Use code <strong>2NDCITY</strong> at checkout to register in your second city for only $35.</p>
          </div>
